...
blue_multiplier = 0.6  # Pour écarter la bande bleue
green_multiplier = 0.9  # Pour écarter la bande verte
yellow_multiplier = 1.35  # La bande jaune reste inchangée
orange_multiplier = 2.025  # Pour écarter la bande orange
red_multiplier = 3.0375  # Pour écarter la bande rouge
